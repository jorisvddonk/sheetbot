...
SELECT data.*,
  COALESCE(((data.rust_surf IS NOT NULL AND data.orig_surf IS NOT NULL AND data.rust_surf != data.orig_surf) +
    ...
    (data.rust_sect_rand_sky IS NOT NULL AND data.orig_sect_rand_sky IS NOT NULL AND data.rust_sect_rand_sky != data.orig_sect_rand_sky)), 0) + COALESCE(((data.lr_surf IS NOT NULL AND data.orig_surf IS NOT NULL AND data.lr_surf != data.orig_surf) +
    ...
    (data.lr_sect_rand_sky IS NOT NULL AND data.orig_sect_rand_sky IS NOT NULL AND data.lr_sect_rand_sky != data.orig_sect_rand_sky)), 0) AS errors,
