...
- **Widgets**: Add new widget types (see [Widgets](docs/widgets.md))
- **Sheet Views**: Customize data presentation with widgets and column structures (see [Sheet Database Table Structure](docs/sheet_db_tablestructure.md))
- **Custom Runners**: Implement new execution environments (see [Agent Runtime Implementation](docs/agent_runtime_implementation.md))
- **Capabilities**: Customize agent matching logic (see [Capabilities](docs/capabilities.md))
- **Distributed Runtime**: Enable distributed task execution (see [Distributed Runtime](docs/Distributed_Runtime.md))
