...
export class JsonSchemaExplanationWidget extends LitElement {
    static styles = css`
      div {
        width: 100%;
        display: flex;
    ...
    render() {
      ...
      return html`<div>
        <div class="schema">
          <div class="schema-detail">${explanation}</div>
        </div>
      </div>`;
    }
  ...
  customElements.define('widget-jsonschema-explanation', JsonSchemaExplanationWidget);